...
{
    [Register("apps.dysfunctional.com.ScaledView")]
    public class ScaledView : View
    {
        ...
        public ScaledView(Context context) : base(context)
        {
            _context = context;
        }

        public ScaledView(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            _context = context;
            SetupCustomAttributes(attrs);
        }

        public ScaledView(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
            _context = context;
            SetupCustomAttributes(attrs);           
        }
