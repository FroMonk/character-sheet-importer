...
{
    [Register("apps.dysfunctional.com.ScaledLinearLayout")]
    public class ScaledLinearLayout : LinearLayout
    {
        ...
        public ScaledLinearLayout(Context context) : base(context)
        {
            _context = context;
        }

        public ScaledLinearLayout(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            _context = context;
            SetupCustomAttributes(attrs);
        }

        public ScaledLinearLayout(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
            _context = context;
            SetupCustomAttributes(attrs);           
        }
