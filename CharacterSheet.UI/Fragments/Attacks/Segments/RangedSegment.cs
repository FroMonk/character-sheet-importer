...
{
    public class RangedSegment : BaseAttacksSegment
    {
        ...
        private readonly Dictionary<int, int> _headerViewMap = new Dictionary<int, int>
        {
            ...
            [2] = Resource.Id.attacks_attack_ranged_range_three_header,
            [3] = Resource.Id.attacks_attack_ranged_range_four_header,
            [4] = Resource.Id.attacks_attack_ranged_range_five_header
        };
        ...
        private readonly Dictionary<int, int> _bonusViewMap = new Dictionary<int, int>
        {
            ...
            [2] = Resource.Id.attacks_attack_ranged_range_three_bonus,
            [3] = Resource.Id.attacks_attack_ranged_range_four_bonus,
            [4] = Resource.Id.attacks_attack_ranged_range_five_bonus
        };
        ...
        private readonly Dictionary<int, int> _damageViewMap = new Dictionary<int, int>
        {
            ...
            [2] = Resource.Id.attacks_attack_ranged_range_three_damage,
            [3] = Resource.Id.attacks_attack_ranged_range_four_damage,
            [4] = Resource.Id.attacks_attack_ranged_range_five_damage
        };

        public ViewGroup Layout { get; protected set; }

        public RangedSegment(Activity activity, LayoutInflater inflater, Weapon weapon, bool isEven) : base(activity)
        {
            ...
            Layout = (ViewGroup)inflater.Inflate(mainActivity.FormatHelper.DeviceHelper.IsPhonePortrait ? Resource.Layout.attacks_fragment_min_ranged : Resource.Layout.attacks_fragment_ranged, null);
        ...
        private RangedAmmunitionSegment AddAmmoToGrid(MainActivity activity, LayoutInflater inflater, Ammunition ammo, Weapon weapon, bool isEven, GridLayout grid)
        {
            ...
            ammoLayoutParams.ColumnSpec = isPhonePortrait ? GridLayout.InvokeSpec(0, 3) : GridLayout.InvokeSpec(1, 5);
        ...
        private void SetupAttack(int count, RangedAttack attack)
        {
            ...
            headerView.SetText(attack.Range);
